...
void generatebill()
{
    ...
    int total=0;
    fstream rd,wr;
    rd.open("c:\\myfiles\\products.txt",ios::in);
    if(!rd)
    {
    ...
    else
    {
        ...
        while(scanid!=0)
        {
            ...
            else
            {
                ...
                if(flag==1)
                {
                    wr.open("c:\\myfiles\\bills.txt",ios::app);
...
void displaybill(int billno)
{
  ...
  fstream rd;
  rd.open("c:\\myfiles\\bills.txt",ios::in);
  if(!rd)
  {
      cout<<"Error opening file "<<endl;
  }
...
{
    fstream wr;
    wr.open("c:\\myfiles\\products.txt",ios::app);
    if(!wr)
    {
        cout<<"Error opening file "<<endl;
    }
...
void dailysale()
{
    ...
    cout<<"Enter date : ";
    cin>>date;
    fstream rd("c:\\myfiles\\bills.txt",ios::in);
    if(!rd)
    {
        cout<<"Error opening file "<<endl;
    }
